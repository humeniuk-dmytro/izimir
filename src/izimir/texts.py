...
# Префикс планового (по расписанию) сканирования — отправляется владельцу
# всегда, даже если ничего не найдено, чтобы было видно, что расписание работает.
SCHEDULED_PREFIX = "🕒 Плановое сканирование (по расписанию)"
